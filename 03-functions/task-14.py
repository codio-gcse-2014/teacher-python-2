...
#takes the sum of everything in a list (using a built-in Python sum of list function, divides by the length (number of elements) of the same list – which is average, forces it to be a real number (possibly, optional here, but good practice to control the type of the data a function returns)
